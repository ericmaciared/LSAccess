...
void CantaPartAlta(char c) {
	 SetD7(c & 0x80 ? HIGH : LOW);
	 SetD6(c & 0x40 ? HIGH : LOW);
	 SetD5(c & 0x20 ? HIGH : LOW);
	 SetD4(c & 0x10 ? HIGH : LOW);
}

void CantaPartBaixa(char c) {
	 SetD7(c & 0x08 ? HIGH : LOW);
	 SetD6(c & 0x04 ? HIGH : LOW);
	 SetD5(c & 0x02 ? HIGH : LOW);
	 SetD4(c & 0x01 ? HIGH : LOW);
}
...
void EscriuPrimeraOrdre(char ordre) {
	...
	EnableUp(); EnableUp();
	 SetD7(ordre & 0x08 ? HIGH : LOW);
	 SetD6(ordre & 0x04 ? HIGH : LOW);
	 SetD5(ordre & 0x02 ? HIGH : LOW);
	 SetD4(ordre & 0x01 ? HIGH : LOW);
	EnableDown();
}
